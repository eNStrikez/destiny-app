 ...
 * @enum
 */
export declare enum DestinyAdvancedAwaType {
    None = 0,
    InsertPlugs = 1,
    BuyItemFromVendor = 2,
    RefundItem = 3,
...
export declare enum DestinyAdvancedAwaResponseReason {
    None = 0,
    Answered = 1,
    TimedOut = 2,
    Replaced = 3
}
export declare enum DestinyAdvancedAwaUserSelection {
    None = 0,
    Rejected = 1,
    Approved = 2
}
 ...
 * @enum
 */
export declare enum DestinyGameVersion {
    None = 0,
    Destiny2 = 1
}
/**
...
export declare enum SocketResponseCodes {
    None = 0,
 ...
 * @enum
 */
export declare enum StatsCategoryType {
    None = 0,
    Kills = 1,
    Assists = 2,
    Deaths = 3,
 ...
 * @enum
 */
export declare enum VendorItemRefundPolicy {
    NotRefundable = 0,
    DeletesItem = 1,
    RevokesLicense = 2
}
